...
def get_default_commands(lang: str = 'en') -> list[BotCommand]:
    commands = [
        BotCommand('/menu', _('menu', locale=lang)),
        BotCommand('/sentence', _('sentences', locale=lang)),
        BotCommand('/collection', _('collections', locale=lang)),
        BotCommand('/start', _('show tutorial', locale=lang)),
