...
def migrate(migrator: Migrator, database: pw.Database, fake=False, **kwargs):
    ...
    class User(pw.Model):
        ...
        select_collection_id = pw.BigIntegerField(null=True)
    ...
    class Collection(pw.Model):
        ...
        user_id = pw.ForeignKeyField(column_name='user_id', field='id', model=migrator.orm['users'])
        created_at = pw.DateTimeField()
    ...
    class Sentence(pw.Model):
        ...
        collection_id = pw.ForeignKeyField(column_name='collection_id', field='id', model=migrator.orm['collections'])
